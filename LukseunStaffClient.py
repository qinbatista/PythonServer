...
if __name__ == '__main__':
	...
	for ProccIncreaseIndex in range(1,11):
		for PortIncreaseIndex in range(1,11):
			ct = LukseunClient("workingcat",ServerPortNumber=PortIncreaseIndex)
			ct.Test_MultMessage("{\"MacAddress\":\"ACDE48001122\", \"Function\":\"CheckIn\",\"UserName\":\"abc\", \"Random\":\"774\"}",1,1000*ProccIncreaseIndex)
			DebugUtility.ErrorRate(1,100*ProccIncreaseIndex,PortIncreaseIndex)

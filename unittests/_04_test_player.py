...
def test_try_remove_coin():
	result = requests.post(MANAGER_BAG_BASE_URL + '/try_remove_coin', data={'unique_id': "4", "value": 255})
	print(str(result.text))
	
	
def test_try_remove_iron():
	result = requests.post(MANAGER_BAG_BASE_URL + '/try_remove_iron', data={'unique_id': "4", "value": -50})
	print(str(result.text))
	
	
def test_try_remove_diamond():
	# result = requests.post(MANAGER_BAG_BASE_URL + '/try_remove_diamond', data={'unique_id': "4", "value": -1000})

...
def pass_stage():
	...
	# result = requests.post(GAME_MANAGER_BASE_URL + '/pass_stage', data={'unique_id': "4", "stage": 1})
	print(str(result.text))


def get_skill():
	result = requests.post(MANAGER_SKILL_BASE_URL + '/get_skill', data={'unique_id': "4", "skill_id": "m1_level"})
	# result = requests.post(GAME_MANAGER_BASE_URL + '/get_skill', data={'unique_id': "4", "stage": 1})
	print(str(result.text))
...
def level_up_skill():
	...
	# result = requests.post(GAME_MANAGER_BASE_URL + '/level_up_skill', data={'unique_id': "4"})
	print(str(result.text))

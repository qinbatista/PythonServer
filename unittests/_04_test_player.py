...
def all_function(unique_id: str):
	result = requests.post('http://localhost:8004/distribution_worker', data={"world": 0, 'unique_id': unique_id, 'workers_quantity': 1, 'factory_kind': "food"})
	print(str(result.text))
	result = requests.post('http://localhost:8004/distribution_worker', data={"world": 0, 'unique_id': unique_id, 'workers_quantity': 1, 'factory_kind': "mine"})
	print(str(result.text))
	result = requests.post('http://localhost:8004/distribution_worker', data={"world": 0, 'unique_id': unique_id, 'workers_quantity': 1, 'factory_kind': "crystal"})
	print(str(result.text))
	result = requests.post('http://localhost:8004/distribution_worker', data={"world": 0, 'unique_id': unique_id, 'workers_quantity': 1, 'factory_kind': "equipment"})
	print(str(result.text))

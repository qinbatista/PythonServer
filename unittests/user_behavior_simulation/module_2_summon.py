...
def basic_summon(**kwargs):
	response = send_tcp_message({'world' : kwargs['world'], 'function' : 'basic_summon', 'data' : {'token' : kwargs['token'],"item":random.choice([1,5])}})
	logger.debug(response)

@login_decoration
def pro_summon(**kwargs):
	response = send_tcp_message({'world' : kwargs['world'], 'function' : 'pro_summon', 'data' : {'token' : kwargs['token'],"item":random.choice([1,5])}})
	logger.debug(response)

@login_decoration
def friend_summon(**kwargs):
	response = send_tcp_message({'world' : kwargs['world'], 'function' : 'friend_summon', 'data' : {'token' : kwargs['token'],"item":random.choice([1,5])}})
	logger.debug(response)

@login_decoration
def basic_summon_skill(**kwargs):
	response = send_tcp_message({'world' : kwargs['world'], 'function' : 'basic_summon_skill', 'data' : {'token' : kwargs['token'],"item":random.choice([1,5])}})
	logger.debug(response)

@login_decoration
def pro_summon_skill(**kwargs):
	response = send_tcp_message({'world' : kwargs['world'], 'function' : 'pro_summon_skill', 'data' : {'token' : kwargs['token'],"item":random.choice([1,5])}})
	logger.debug(response)

@login_decoration
def friend_summon_skill(**kwargs):
	response = send_tcp_message({'world' : kwargs['world'], 'function' : 'friend_summon_skill', 'data' : {'token' : kwargs['token'],"item":random.choice([1,5])}})
	logger.debug(response)

@login_decoration
def basic_summon_role(**kwargs):
	response = send_tcp_message({'world' : kwargs['world'], 'function' : 'basic_summon_role', 'data' : {'token' : kwargs['token'],"item":random.choice([1,5])}})
	logger.debug(response)

@login_decoration
def pro_summon_role(**kwargs):
	response = send_tcp_message({'world' : kwargs['world'], 'function' : 'pro_summon_role', 'data' : {'token' : kwargs['token'],"item":random.choice([1,5])}})
	logger.debug(response)

@login_decoration
def friend_summon_role(**kwargs):
	response = send_tcp_message({'world' : kwargs['world'], 'function' : 'friend_summon_role', 'data' : {'token' : kwargs['token'],"item":random.choice([1,5])}})
	logger.debug(response)

@login_decoration
def basic_summon_10_times(**kwargs):
	response = send_tcp_message({'world' : kwargs['world'], 'function' : 'basic_summon_10_times', 'data' : {'token' : kwargs['token'],"item":random.choice([1,5])}})
	logger.debug(response)
...
def friend_summon_10_times(**kwargs):
	response = send_tcp_message({'world' : kwargs['world'], 'function' : 'friend_summon_10_times', 'data' : {'token' : kwargs['token'],"item":random.choice([1,5])}})#能量包，1是1张， 2是3张，3是10张
	logger.debug(response)

@login_decoration
def basic_summon_skill_10_times(**kwargs):
	response = send_tcp_message({'world' : kwargs['world'], 'function' : 'basic_summon_skill_10_times', 'data' : {'token' : kwargs['token'],"item":random.choice([1,5])}})#能量包，1是1张， 2是3张，3是10张
	logger.debug(response)

@login_decoration
def pro_summon_skill_10_times(**kwargs):
	response = send_tcp_message({'world' : kwargs['world'], 'function' : 'pro_summon_skill_10_times', 'data' : {'token' : kwargs['token'],"item":random.choice([1,5])}})#能量包，1是1张， 2是3张，3是10张
	logger.debug(response)

@login_decoration
def friend_summon_skill_10_times(**kwargs):
	response = send_tcp_message({'world' : kwargs['world'], 'function' : 'friend_summon_skill_10_times', 'data' : {'token' : kwargs['token'],"item":random.choice([1,5])}})#能量包，1是1张， 2是3张，3是10张
	logger.debug(response)

@login_decoration
def basic_summon_role_10_times(**kwargs):
	response = send_tcp_message({'world' : kwargs['world'], 'function' : 'basic_summon_role_10_times', 'data' : {'token' : kwargs['token'],"item":random.choice([1,5])}})#能量包，1是1张， 2是3张，3是10张
	logger.debug(response)

@login_decoration
def pro_summon_role_10_times(**kwargs):
	response = send_tcp_message({'world' : kwargs['world'], 'function' : 'pro_summon_role_10_times', 'data' : {'token' : kwargs['token'],"item":random.choice([1,5])}})#能量包，1是1张， 2是3张，3是10张
	logger.debug(response)

@login_decoration
def friend_summon_role_10_times(**kwargs):
	response = send_tcp_message({'world' : kwargs['world'], 'function' : 'friend_summon_role_10_times', 'data' : {'token' : kwargs['token'],"item":random.choice([1,5])}})#能量包，1是1张， 2是3张，3是10张
	logger.debug(response)

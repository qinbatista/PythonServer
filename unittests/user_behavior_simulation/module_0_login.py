...
def login_unique():#游客登陆
	...
	response = user_behavior_simulation.send_tcp_message({'function' : 'login_unique', 'data' : {'unique_id' : my_unique_id}})
...
def enter_world(token,target_world):
	response = user_behavior_simulation.send_tcp_message({'function' : 'enter_world','world':str(target_world), 'data' : {"token":token,"target_world":target_world}})
...
def create_player(token,target_world,game_name):
	response = user_behavior_simulation.send_tcp_message({"world":target_world,'function' : 'create_player', 'data' : {"token":token,"gn":game_name}})
...
def get_account_world_info(token):
	response = user_behavior_simulation.send_tcp_message({'function' : 'get_account_world_info', 'data' : {"token":token}})

...
def request_friend():
	...
	# response = user_behavior_simulation.send_tcp_message({'world' : world, 'function' : 'request_friend', 'data' : {'token' : token,"gn_target":"劲瞄紧雨诌霖"}})#发送好友信息
...
def find_person():
	...
	response = user_behavior_simulation.send_tcp_message({'world' : world, 'function' : 'find_person', 'data' : {'token' : token,"gn_target":"劲瞄紧雨诌霖"}})#发送好友信息
